...
from thunder_fighter.utils.resource_manager import ResourceManager, get_music_path, load_font, load_image, load_sound
...
class TestResourceManager(unittest.TestCase):
    ...
    def test_preload_common_assets(self, mock_assets_dir):
        ...
        with patch("thunder_fighter.utils.resource_manager.ASSETS_DIR", self.test_assets_dir):
            ...
            with patch.object(manager, "load_sound") as mock_load_sound, patch.object(
                manager, "load_font"
            ) as mock_load_font:
    ...
    def test_get_cache_stats(self, mock_assets_dir):
        ...
        with patch("thunder_fighter.utils.resource_manager.ASSETS_DIR", self.test_assets_dir):
            ...
            # Verify stats
            expected_stats = {"images": 2, "sounds": 1, "fonts": 3}
