...
class TestLanguageManager:
    ...
    def test_initialization_with_custom_loader(self):
        ...
        custom_loader = MemoryLanguageLoader({
    ...
    def test_get_text_existing_key(self):
        ...
        manager = LanguageManager(loader=MemoryLanguageLoader({
            'test': {'hello': 'Hello World', 'greeting': 'Hi {name}!'}
        }))
    ...
    def test_get_text_formatting_error(self):
        ...
        manager = LanguageManager(loader=MemoryLanguageLoader({
            'test': {'bad_format': 'Hello {missing_arg}!'}
        }))
        manager.load_language('test')
...
class TestLocalizationIntegration:
    ...
    def test_file_to_memory_migration(self):
        ...
        memory_loader = MemoryLanguageLoader({
            'custom': {'GAME_TITLE': 'Custom Game Title'}
        })
    ...
    def test_fallback_chain(self):
        ...
        loader.load.side_effect = lambda lang: (
            {'GAME_TITLE': 'Thunder Fighter'} if lang == 'en' else None
        )
    ...
    def test_concurrent_access_safety(self):
        ...
        manager = LanguageManager(loader=MemoryLanguageLoader({
            'en': {'counter': 'English {count}'},
            'zh': {'counter': 'Chinese {count}'}
        }))
