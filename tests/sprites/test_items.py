...
class TestItems(unittest.TestCase):
    ...
    def test_create_random_item_logic(
        self,
        mock_create_wingman,
        mock_create_player_speed,
        mock_create_bullet_path,
        mock_create_bullet_speed,
        mock_create_health,
        mock_choices,
    ):
        ...
        def run_test(item_class, game_time, game_level):
            ...
            item = create_random_item(
                game_time, game_level, self.mock_sprites_group, self.mock_items_group, self.mock_player
            )
