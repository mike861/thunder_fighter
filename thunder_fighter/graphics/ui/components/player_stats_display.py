...
class PlayerStatsDisplay:
    ...
    def update_info(self, health=None, max_health=None, bullet_paths=None, bullet_speed=None, speed=None, wingmen=None):
        """
    ...
    def draw(self):
        ...
        # Draw health bar
        self.health_bar.draw(x, y, 150, 20, self.player_info["health"], self.player_info["max_health"])
