...
class BossFactory(ConfigurableEntityFactory[Boss]):
    ...
    def _setup_default_presets(self):
        ...
        self.add_preset(
            "standard", {"boss_level": 1, "game_level": 2, "health_multiplier": 1.0, "speed_multiplier": 1.0}
        )

        self.add_preset("elite", {"boss_level": 2, "game_level": 5, "health_multiplier": 1.5, "speed_multiplier": 1.2})
